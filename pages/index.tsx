...
const Home: NextPage = () => {
  ...
  return (
    <div className= "z-0 flex flex-col items-center justify-center min-h-screen text-white bg-center bg-cover bg-bg main-container ">
      ...
      <main className="flex flex-col justify-start flex-1 w-full max-w-md px-5 text-center">
        <div className="flex flex-col mt-10">
          <label htmlFor="phone" className="text-left text-white text-md">
            Número de telemóvel: 
          </label>
          <input
            className="p-0 py-1 pt-2 text-white bg-transparent border-b border-white border-x-transparent border-t-transparent placeholder:text-gray-300"
            type="tel"
            onFocus={() => setErr("")}
            onChange={(e) => handlePhone(e.target.value)}
            placeholder="Por favor insira o seu número de telemóvel"
            value={phone}
          />
          ...
          <div
            ...
            className="flex justify-center flex-1 p-5 mx-auto mt-6 align-middle transition-all border-2 border-white cursor-pointer lg:w-full hover:bg-white hover:text-black"
          >
            Confirmar Presença
          </div>
        </div>
